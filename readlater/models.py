...
class Article(models.Model):
    ...
    name = models.CharField(max_length=100, help_text='Name of article.')
    url = models.URLField(max_length=200, help_text='URL for article.')
    category = models.ForeignKey(Category, on_delete=models.CASCADE, help_text='Article category.')
    rank = models.ForeignKey(Rank, on_delete=models.CASCADE, help_text='Article rank.')
    ...
    finished_time = models.DateTimeField(null=True, blank=True, help_text='Timestamp for when article was finished.')
    updated_time = models.DateTimeField(null=True, blank=True, help_text='Timestamp for when progress was updated.')
